...
def check_abnormal_volume_gazp():
    with Client(TOKEN) as client:        
        ...
        gazp_abnormal_volumes = []
        gazp_abnormal_volumes_df = {"Объем": gazp_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std

            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                gazp_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{GAZP.ticker} {GAZP.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\n \nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{GAZP.ticker} {GAZP.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\n \nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(gazp_abnormal_volumes_df)
        print(f'#{GAZP.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_vtbr():
    with Client(TOKEN) as client:        
        ...
        vtbr_abnormal_volumes = []
        vtbr_abnormal_volumes_df = {"Объем": vtbr_abnormal_volumes}
        ...
        for i in range(len(df)):
            ...
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                vtbr_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{VTBR.ticker} {VTBR.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{VTBR.ticker} {VTBR.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(vtbr_abnormal_volumes_df)
        print(f'#{VTBR.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_lkoh():
    with Client(TOKEN) as client:        
        ...
        lkoh_abnormal_volumes = []
        lkoh_abnormal_volumes_df = {"Объем": lkoh_abnormal_volumes}
        ...
        for i in range(len(df)):
            ...
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                lkoh_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{LKOH.ticker} {LKOH.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
        
                else:
                    print(f'#{LKOH.ticker} {LKOH.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(lkoh_abnormal_volumes_df)
        print(f'#{LKOH.ticker} Min abnormal volume: {df_2["Объем"].min()}')
...
def check_abnormal_volume_yndx():
    with Client(TOKEN) as client:        
        ...
        yndx_abnormal_volumes = []
        yndx_abnormal_volumes_df = {"Объем": yndx_abnormal_volumes}
        ...
        for i in range(len(df)):
            ...
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                yndx_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{YNDX.ticker} {YNDX.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{YNDX.ticker} {YNDX.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(yndx_abnormal_volumes_df)
        print(f'#{YNDX.ticker} Min abnormal volume {get_final_float_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_mgnt():
    with Client(TOKEN) as client:        
        ...
        mgnt_abnormal_volumes = []
        mgnt_abnormal_volumes_df = {"Объем": mgnt_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                mgnt_abnormal_volumes.append(df["Объем"].iloc[i])
        ...
        df_2 = pd.DataFrame(mgnt_abnormal_volumes_df)
        print(f'#{MGNT.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_poly():
    with Client(TOKEN) as client:        
        ...
        poly_abnormal_volumes = []
        poly_abnormal_volumes_df = {"Объем": poly_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                poly_abnormal_volumes.append(df["Объем"].iloc[i])
        ...
        df_2 = pd.DataFrame(poly_abnormal_volumes_df)
        print(f'#{POLY.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_sberp():
    with Client(TOKEN) as client:        
        ...
        sberp_abnormal_volumes = []
        sberp_abnormal_volumes_df = {"Объем": sberp_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                sberp_abnormal_volumes.append(df["Объем"].iloc[i])
        ...
        df_2 = pd.DataFrame(sberp_abnormal_volumes_df)
        print(f'#{SBERP.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_chmf():
    with Client(TOKEN) as client:        
        ...
        chmf_abnormal_volumes = []
        chmf_abnormal_volumes_df = {"Объем": chmf_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                chmf_abnormal_volumes.append(df["Объем"].iloc[i])
        ...
        df_2 = pd.DataFrame(chmf_abnormal_volumes_df)
        print(f'#{CHMF.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_alrs():
    with Client(TOKEN) as client:        
        ...
        alrs_abnormal_volumes = []
        alrs_abnormal_volumes_df = {"Объем": alrs_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                alrs_abnormal_volumes.append(df["Объем"].iloc[i])
        ...
        df_2 = pd.DataFrame(alrs_abnormal_volumes_df)
        print(f'#{ALRS.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_mmk():
    with Client(TOKEN) as client:        
        ...
        mmk_abnormal_volumes = []
        mmk_abnormal_volumes_df = {"Объем": mmk_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                mmk_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{MMK.ticker} {MMK.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{MMK.ticker} {MMK.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(mmk_abnormal_volumes_df)
        print(f'#{MMK.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_phor():
    with Client(TOKEN) as client:        
        ...
        phor_abnormal_volumes = []
        phor_abnormal_volumes_df = {"Объем": phor_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                phor_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{PHOR.ticker} {PHOR.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{PHOR.ticker} {PHOR.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(phor_abnormal_volumes_df)
        print(f'#{PHOR.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_sngs():
    with Client(TOKEN) as client:        
        ...
        sngs_abnormal_volumes = []
        sngs_abnormal_volumes_df = {"Объем": sngs_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                sngs_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{SNGS.ticker} {SNGS.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_sngs(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{SNGS.ticker} {SNGS.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_sngs(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(sngs_abnormal_volumes_df)
        print(f'#{SNGS.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_sngs(df_2["Объем"].min()))}')
...
def check_abnormal_volume_sngsp():
    with Client(TOKEN) as client:        
        ...
        sngsp_abnormal_volume = []
        sngsp_abnormal_volume_df = {"Объем": sngsp_abnormal_volume}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                sngsp_abnormal_volume.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{SNGSP.ticker} {SNGSP.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_sngsp(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{SNGSP.ticker} {SNGSP.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_sngsp(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(sngsp_abnormal_volume_df)
        print(f'#{SNGSP.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_sngsp(df_2["Объем"].min()))}')
...
def check_abnormal_volume_nlmk():
    with Client(TOKEN) as client:        
        ...
        nlmk_abnormal_volume = []
        nlmk_abnormal_volume_df = {"Объем": nlmk_abnormal_volume}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                nlmk_abnormal_volume.append(df["Объем"].iloc[i])
        ...
        df_2 = pd.DataFrame(nlmk_abnormal_volume_df)
        print(f'#{NLMK.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_plzl():
    with Client(TOKEN) as client:        
        ...
        plzl_abnormal_volume = []
        plzl_abnormal_volume_df = {"Объем": plzl_abnormal_volume}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                plzl_abnormal_volume.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
                send_message(f'#{PLZL.ticker} {PLZL.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 1])}\n{get_stock_volumes(df["Объем"].iloc[-1])} ({df["Лоты"].iloc[-1]})\nПокупка: {df["Покупка"].iloc[-1]}% Продажа: {df["Продажа"].iloc[-1]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[-1])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 840])}\nЗаметил Баффет на Уораннах.')
            else:
                send_message(f'#{PLZL.ticker} {PLZL.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 1])}\n{get_stock_volumes(df["Объем"].iloc[-1])} ({df["Лоты"].iloc[-1]})\nПокупка: {df["Покупка"].iloc[-1]}% Продажа: {df["Продажа"].iloc[-1]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[-1])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(plzl_abnormal_volume_df)
        print(f'#{PLZL.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_tatn():
    with Client(TOKEN) as client:        
        ...
        tatn_abnormal_volumes = []
        tatn_abnormal_volumes_df = {"Объем": tatn_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                tatn_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
                    print(f'#{TATN.ticker} {TATN.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{TATN.ticker} {TATN.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(tatn_abnormal_volumes_df)
        print(f'#{TATN.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_mtlr():
    with Client(TOKEN) as client:        
        ...
        mtlr_abnormal_volumes = []
        mtlr_abnormal_volumes_df = {"Объем": mtlr_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                mtlr_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
                send_message(f'#{MTLR.ticker} {MTLR.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 1])}\n{get_stock_volumes(df["Объем"].iloc[-1])} ({df["Лоты"].iloc[-1]})\nПокупка: {df["Покупка"].iloc[-1]}% Продажа: {df["Продажа"].iloc[-1]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[-1])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 840])}\nЗаметил Баффет на Уораннах.')
            else:
                send_message(f'#{MTLR.ticker} {MTLR.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 1])}\n{get_stock_volumes(df["Объем"].iloc[-1])} ({df["Лоты"].iloc[-1]})\nПокупка: {df["Покупка"].iloc[-1]}% Продажа: {df["Продажа"].iloc[-1]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[-1])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(mtlr_abnormal_volumes_df)
        print(f'#{MTLR.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_mtss():
    with Client(TOKEN) as client:        
        ...
        mtss_abnormal_volumes = []
        mtss_abnormal_volumes_df = {"Объем": mtss_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                mtss_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
                send_message(f'#{MTSS.ticker} {MTSS.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[-1]))} ({df["Лоты"].iloc[-1]})\nПокупка: {df["Покупка"].iloc[-1]}% Продажа: {df["Продажа"].iloc[-1]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[-1])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 840])}\nЗаметил Баффет на Уораннах.')
            else:
                send_message(f'#{MTSS.ticker} {MTSS.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[-1]))} ({df["Лоты"].iloc[-1]})\nПокупка: {df["Покупка"].iloc[-1]}% Продажа: {df["Продажа"].iloc[-1]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[-1])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[-1], df["Цена"].iloc[-1 - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(mtss_abnormal_volumes_df)
        print(f'#{MTSS.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_moex():
    with Client(TOKEN) as client:        
        ...
        moex_abnormal_volumes = []
        moex_abnormal_volumes_df = {"Объем": moex_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                moex_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(moex_abnormal_volumes_df)
        print(f'#{MOEX.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_rual():
    with Client(TOKEN) as client:        
        ...
        rual_abnormal_volumes = []
        rual_abnormal_volumes_df = {"Объем": rual_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                rual_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{RUAL.ticker} {RUAL.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{RUAL.ticker} {RUAL.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(rual_abnormal_volumes_df)
        print(f'#{RUAL.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_aflt():
    with Client(TOKEN) as client:        
        ...
        aflt_abnormal_volumes = []
        aflt_abnormal_volumes_df = {"Объем": aflt_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                aflt_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(aflt_abnormal_volumes_df)
        print(f'#{AFLT.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_cbom():
    with Client(TOKEN) as client:        
        ...
        cbom_abnormal_volumes = []
        cbom_abnormal_volumes_df = {"Объем": cbom_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                cbom_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{CBOM.ticker} {CBOM.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_cbom(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{CBOM.ticker} {CBOM.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_cbom(df["Объем"].iloc[i]))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(cbom_abnormal_volumes_df)
        print(f'#{CBOM.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_cbom(df_2["Объем"].min()))}')
...
def check_abnormal_volume_ozon():
    with Client(TOKEN) as client:        
        ...
        ozon_abnormal_volumes = []
        ozon_abnormal_volumes_df = {"Объем": ozon_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                ozon_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(ozon_abnormal_volumes_df)
        print(f'#{OZON.ticker} Min abnormal Volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_afks():
    with Client(TOKEN) as client:        
        ...
        afks_abnormal_volumes = []
        afks_abnormal_volumes_df = {"Объем": afks_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                afks_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(afks_abnormal_volumes_df)
        print(f'#{AFKS.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_afks(df_2["Объем"].min()))}')
...
def check_abnormal_volume_smlt():
    with Client(TOKEN) as client:        
        ...
        smlt_abnormal_volumes = []
        smlt_abnormal_volumes_df = {"Объем": smlt_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                smlt_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(smlt_abnormal_volumes_df)
        print(f'#{SMLT.ticker} Min abnormal volumes: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_spbe():
    with Client(TOKEN) as client:        
        ...
        spbe_abnormal_volumes = []
        spbe_abnormal_volumes_df = {"Объем": spbe_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                spbe_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(spbe_abnormal_volumes_df)
        print(f'#{SPBE.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_pikk():
    with Client(TOKEN) as client:        
        ...
        pikk_abnormal_volumes = []
        pikk_abnormal_volumes_df = {"Объем": pikk_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                pikk_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{PIKK.ticker} {PIKK.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{PIKK.ticker} {PIKK.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(pikk_abnormal_volumes_df)
        print(f'#{PIKK.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_irao():
    with Client(TOKEN) as client:        
        ...
        irao_abnormal_volumes = []
        irao_abnormal_volumes_df = {"Объем": irao_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                irao_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(irao_abnormal_volumes_df)
        print(f'#{IRAO.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_irao(df_2["Объем"].min()))}')
...
def check_abnormal_volume_sibn():
    with Client(TOKEN) as client:        
        ...
        sibn_abnormal_volumes = []
        sibn_abnormal_volumes_df = {"Объем": sibn_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                sibn_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(sibn_abnormal_volumes_df)
        print(f'#{SIBN.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_rasp():
    with Client(TOKEN) as client:        
        ...
        rasp_abnormal_volumes = []
        rasp_abnormal_volumes_df = {"Объем": rasp_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                rasp_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(rasp_abnormal_volumes_df)
        print(f'#{RASP.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_sgzh():
    with Client(TOKEN) as client:        
        ...
        sgzh_abnormal_volumes = []
        sgzh_abnormal_volumes_df = {"Объем": sgzh_abnormal_volumes}
        ...
        for i in range(len(df)):
            ...
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                sgzh_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{SGZH.ticker} {SGZH.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i])))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{SGZH.ticker} {SGZH.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(make_million_volumes_on_int_stock_prices(make_million_volumes_on_int_stock_prices(df["Объем"].iloc[i])))} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[-1]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
            
        
        df_2 = pd.DataFrame(sgzh_abnormal_volumes_df)
        print(f'#{SGZH.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(make_million_volumes_on_int_stock_prices(df_2["Объем"].min())))}')
...
def check_abnormal_volume_dsky():
    with Client(TOKEN) as client:        
        ...
        dsky_abnormal_volumes = []
        dsky_abnormal_volumes_df = {"Объем": dsky_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                dsky_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(dsky_abnormal_volumes_df)
        print(f'#{DSKY.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_trnfp():
    with Client(TOKEN) as client:        
        ...
        trnfp_abnormal_volumes = []
        trnfp_abnormal_volumes_df = {"Объем": trnfp_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                trnfp_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(trnfp_abnormal_volumes_df)
        print(f'#{TRNFP.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_rnft():
    with Client(TOKEN) as client:        
        ...
        rnft_abnormal_volumes = []
        rnft_abnormal_volumes_df = {"Объем": rnft_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                rnft_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(rnft_abnormal_volumes_df)
        print(f'#{RNFT.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_five():
    with Client(TOKEN) as client:        
        ...
        five_abnormal_volumes = []
        five_abnormal_volumes_df = {"Объем": five_abnormal_volumes}
        
        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                five_abnormal_volumes.append(df["Объем"].iloc[i])
                '''if df["Покупка"].iloc[i] > df["Продажа"].iloc[i]:
                    print(f'#{FIVE.ticker} {FIVE.name}\n🟩 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')
                else:
                    print(f'#{FIVE.ticker} {FIVE.name}\n🔻 Аномальный объем\n{calculate_net_change(df["Цена"].iloc[i], df["Цена"].iloc[i - 1])}\n{get_stock_volumes(df["Объем"].iloc[i])} ({df["Лоты"].iloc[i]})\nПокупка: {df["Покупка"].iloc[i]}% Продажа: {df["Продажа"].iloc[i]}%\nВремя: {convert_time_to_moscow(df["Время"].iloc[i])}\nЦена: {df["Цена"].iloc[i]} ₽\n{calculate_net_change_per_day(df["Цена"].iloc[i], df["Цена"].iloc[i - 840])}\nЗаметил Баффет на Уораннах.')'''
        
        df_2 = pd.DataFrame(five_abnormal_volumes_df)
        print(f'#{FIVE.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_bspb():
    with Client(TOKEN) as client:        
        ...
        bspb_abnormal_volumes = []
        bspb_abnormal_volumes_df = {"Объем": bspb_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                bspb_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(bspb_abnormal_volumes_df)
        print(f'#{BSPB.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_flot():
    with Client(TOKEN) as client:        
        ...
        flot_abnormal_volumes = []
        flot_abnormal_volumes_df = {"Объем": flot_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                flot_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(flot_abnormal_volumes_df)
        print(f'#{FLOT.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_uwgn():
    with Client(TOKEN) as client:        
        ...
        uwgn_abnormal_volumes = []
        uwgn_abnormal_volumes_df = {"Объем": uwgn_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                uwgn_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(uwgn_abnormal_volumes_df)
        print(f'#{UWGN.ticker} Min abnormal volume: {get_stock_volumes(df_2["Объем"].min())}')
...
def check_abnormal_volume_mtlrp():
    with Client(TOKEN) as client:        
        ...
        mtlrp_abnormal_volumes = []
        mtlrp_abnormal_volumes_df = {"Объем": mtlrp_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                mtlrp_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(mtlrp_abnormal_volumes_df)
        print(f'#{MTLR.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_iskj():
    with Client(TOKEN) as client:        
        ...
        iskj_abnormal_volumes = []
        iskj_abnormal_volumes_df = {"Объем": iskj_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                iskj_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(iskj_abnormal_volumes_df)
        print(f'#{ISKJ.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_int_stock_prices(df_2["Объем"].min()))}')
...
def check_abnormal_volume_upro():
    with Client(TOKEN) as client:        
        ...
        upro_abnormal_volumes = []
        upro_abnormal_volumes_df = {"Объем": upro_abnormal_volumes}

        for i in range(len(df)):
            abnormal_volume = (df['Объем'].iloc[i] - volume_mean) / volume_std
            abnormal_price_changes = (df['Цена'].iloc[i] - prices_mean) / prices_std
            if abnormal_volume > THRESHOLD or abnormal_price_changes > THRESHOLD:
                upro_abnormal_volumes.append(df["Объем"].iloc[i])
            '''if df["Покупка"].iloc[-1] > df["Продажа"].iloc[-1]:
        ...
        df_2 = pd.DataFrame(upro_abnormal_volumes_df)
        print(f'#{UPRO.ticker} Min abnormal volume: {get_stock_volumes(make_million_volumes_on_upro(df_2["Объем"].min()))}')
